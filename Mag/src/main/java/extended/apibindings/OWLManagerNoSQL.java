...
import extended.impl.OWLOntologyManagerNoSQLImpl;
 ...
 */
public class OWLManagerNoSQL extends OWLManager {
    ...
    @Override
    public OWLOntologyManagerNoSQL buildOWLOntologyManager() {
        return createOWLOntologyManager();
    }

    @Override
    public OWLOntologyManagerNoSQL buildOWLOntologyManager(OWLDataFactory f) {
     ...
     */
    public static OWLOntologyManagerNoSQL createOWLOntologyManager() {
     ...
     * storeres etc.
     *
     * @param dataFactory The data factory that the manager should have a
     * reference to.
     * @return The manager.
     */
    public static OWLOntologyManagerNoSQL createOWLOntologyManager(
        ...
        // storers
        OWLOntologyManagerNoSQL ontologyManager = new OWLOntologyManagerNoSQLImpl(
                dataFactory);
