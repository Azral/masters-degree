...
import extended.cassandra.RDFXMLCassandraRenderer;
 ...
 */
public class RDFXMLOntologyCassandraStorer extends AbstractOWLOntologyNoSQLStorer {
    ...
    protected void storeOntology(OWLOntology ontology, Writer writer,
        ...
        try {
            RDFXMLCassandraRenderer renderer = new RDFXMLCassandraRenderer(ontology, writer,
                    format);
