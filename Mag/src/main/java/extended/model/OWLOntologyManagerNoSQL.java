 ...
 */
public interface OWLOntologyManagerNoSQL extends OWLOntologyManager {
     ...
     *
     * @param ontologyIRI The IRI of the ontology to test for (the version IRI
     * is assumed to be {@code null})
     * @return {@code true} if there is an ontology with the specified IRI, and
     * no version IRI, that is managed by this manager, otherwise {@code false}.
     */
     ...
     *
     * @param ontologyVersionIRI The version IRI of the ontology to test for
     ...
     * this manager.
     *
     * @param ontologyVersionIRI The version IRI to match against all of the
     * known ontologies.
     ...
     * manager does not manage an ontology with the specified ontology ID.
     */
    @Override
     ...
     * {@code null} if the imports declaration could not be resolved to an
     * ontology, because the ontology was not loaded or has been removed from
     * this manager
     */
     ...
     * is related to via the directlyImports relation. If the ontology is not
     ...
     * closure of the directly imports relation of this ontology. If, for what
     * ever reason, an imported ontology could not be loaded, then it will not
     * be contained in the returned set of ontologies. If the ontology is not
     * managed by this manager then the empty set will be returned.
     */
     ...
     * ontology. Example: if A imports B and B imports C, then calling this
     * method with A will return the set consisting of A, B and C. If, for what
     * ever reason, an imported ontology could not be loaded, then it will not
     * be contained in the returned set of ontologies. If the ontology is not
     * managed by this manager then the empty set will be returned.
     */
     ...
     * closure. The first element in the list will be the specified ontology. If
     * the ontology is not managed by this manager then an empty list will be
     * returned.
     */
     ...
     * @throws OWLOntologyChangeException If one or more of the changes could
     * not be applied. See subclasses of ontology change exception for more
     * specific details.
     * @throws OWLOntologyRenameException If one or more of the changes is an
     * instance of {@link org.semanticweb.owlapi.model.SetOntologyID} where the
     * new {@link org.semanticweb.owlapi.model.OWLOntologyID} already belongs to
     * an ontology managed by this manager.
     */
    @Override
     ...
     * @throws OWLOntologyChangeException if there was a problem adding the
     * axioms
     */
    @Override
     ...
     * @return A list of ontology changes that represent the changes that
     * actually took place.
     * @throws OWLOntologyChangeException if there was a problem removing the
     * axiom
     */
     ...
     * See subclasses of ontology change exception for more specific details.
     * @throws OWLOntologyRenameException If one or more of the changes is an
     * instance of {@link org.semanticweb.owlapi.model.SetOntologyID} where the
     * new {@link org.semanticweb.owlapi.model.OWLOntologyID} already belongs to
     * an ontology managed by this manager.
     ...
     * @throws OWLOntologyCreationException if there was a problem creating the
     * ontology
     */
     ...
     * @throws OWLOntologyCreationException if there was a problem creating the
     * new ontology.
     * @throws OWLOntologyChangeException if there was a problem copying the
     * axioms.
     */
     ...
     * specified axioms
     * @throws OWLOntologyCreationException if there was a problem creating the
     * new ontology, if the new ontology already exists in this manager.
     * @throws OWLOntologyChangeException if there was a problem copying the
     * axioms.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology with the specified {@code ontologyIRI}.
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified
     * {@code ontologyIRI} is mapped to a ontology document IRI for which there
     * already exists a mapping in this manager.
     */
     ...
     * the value of {@code ontologyIRI}.
     *
     * @param ontologyIRI The IRI of the ontology to be created. The ontology
     * IRI will be mapped to a document IRI in order to determine the type of
     * ontology factory that will be used to create the ontology. If this
     * mapping is {@code null} then a default (in memory) implementation of the
     ...
     * @throws OWLOntologyCreationException If the ontology could not be
     * created.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology with the specified {@code ontologyIRI} (and no version IRI).
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified
     * {@code ontologyIRI} is mapped to a ontology document IRI for which there
     * already exists a mapping in this manager.
     */
     ...
     * created.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology with the specified {@code ontologyID} (and no version IRI).
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified
     * {@code ontologyID} is mapped to a ontology document IRI for which there
     * already exists a mapping in this manager.
     */
     ...
     * @param ontologies The ontologies whose axioms should be copied into the
     * new ontology
     * @param copyLogicalAxiomsOnly If set to {@code true} only logical axioms
     * are copied into the new ontology. If set to {@code false} then all axioms
     * (including annotation axioms) are copied into the new ontology.
     * @return An ontology that has the specified IRI and contains all of the
     * axioms that are contained in the specified ontologies possibly minus all
     * non-logical axioms
     * @throws OWLOntologyCreationException if there was a problem creating the
     * new ontology, if the new ontology already exists in this manager.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology with the specified {@code ontologyIRI} (and no ontology
     * version IRI).
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified
     * {@code ontologyIRI} is mapped to a ontology document IRI for which there
     * already exists a mapping in this manager.
     ...
     *
     * @param ontologyIRI The IRI that identifies the ontology. It is expected
     * that the ontology will also have this IRI (although the OWL API will
     * tolerated situations where this is not the case).
     * @return The {@code OWLOntology} representation of the ontology that was
     * loaded.
     * @throws OWLOntologyCreationException If there was a problem in creating
     * and loading the ontology.
     * @throws org.semanticweb.owlapi.io.UnparsableOntologyException if the
     * ontology was being parsed from a document and the document contained
     * syntax errors.
     * @throws UnloadableImportException if the ontology imports ontologies and
     * one of the imports could not be loaded for what ever reason. If the
     * {@link MissingImportHandlingStrategy} is set to
     * {@link MissingImportHandlingStrategy#SILENT} then this exception will not
     * be thrown. The {@code UnloadableImportException} contains information
     * about the import declaration that triggered the import and the cause of
     * this exception is an {@code OWLOntologyCreationException} which contains
     * information about why the import could not be loaded.
     * @throws org.semanticweb.owlapi.io.OWLOntologyCreationIOException if there
     * was an {@code IOException} when trying to load the ontology.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology with the specified {@code ontologyIRI} (where the ontology
     ...
     *
     * @param documentIRI The ontology document IRI where the ontology will be
     * loaded from.
     ...
     * was an {@code IOException} when trying to load the ontology.
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified
     * {@code documentIRI} is already the document IRI for a loaded ontology.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology whose ontology IRI and version IRI is the same as the
     * ontology IRI and version IRI of the ontology contained in the document
     * pointed to by {@code documentIRI}.
     */
     ...
     * @throws org.semanticweb.owlapi.io.OWLOntologyCreationIOException if there
     * was an {@code IOException} when trying to load the ontology.
     * @throws OWLOntologyDocumentAlreadyExistsException if the IRI of the
     * specified file is already the document IRI for a loaded ontology.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology whose ontology IRI and version IRI is the same as the
     * ontology IRI and version IRI of the ontology contained in the document
     * pointed to by {@code documentIRI}.
     ...
     *
     * @param inputStream The input stream that can be used to obtain a
     ...
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology whose ontology IRI and version IRI is the same as the
     * ontology IRI and version IRI of the ontology obtained from parsing the
     ...
     *
     * @param documentSource The input source that describes where the ontology
     ...
     * @throws org.semanticweb.owlapi.io.OWLOntologyCreationIOException if there
     * was an {@code IOException} when trying to load the ontology.
     * @throws OWLOntologyDocumentAlreadyExistsException if the document IRI of
     * the input source is already the document IRI for a loaded ontology.
     * @throws OWLOntologyAlreadyExistsException if the manager already contains
     * an ontology whose ontology IRI and version IRI is the same as the
     * ontology IRI and version IRI of the ontology contained in the document
     ...
     *
     * @param ontology The ontology to be removed. If this manager does not
     * manage the ontology then nothing happens.
     */
     ...
     * ontologies via imports statements.
     *
     * @param ontologyID The ontology to be removed. If this manager does not
     * manage the ontology then nothing happens.
     */
     ...
     * @throws UnknownOWLOntologyException If the specified ontology is not
     * managed by this manager.
     */
     ...
     * @throws OWLOntologyStorageException An exception will be thrown if there
     * is a problem with saving the ontology, or the ontology can't be saved in
     * the format it was loaded from.
     * @throws UnknownOWLOntologyException if this manager does not manage the
     * specified ontology
     */
    void saveOntology(OWLOntology ontology) throws OWLOntologyStorageException;

    void saveOntologyMongoDB(OWLOntology ontology) throws OWLOntologyStorageException;

    void saveOntologyMongoDB(OWLOntology ontology, IRI iri) throws OWLOntologyStorageException;

    void saveOntologyCassandra(OWLOntology ontology) throws OWLOntologyStorageException;

    void saveOntologyCassandra(OWLOntology ontology, IRI iri) throws OWLOntologyStorageException;
     ...
     * @throws OWLOntologyStorageException If there was a problem saving this
     * ontology to the specified output stream
     * @throws UnknownOWLOntologyException if this manager does not manage the
     * specified ontology.
     */
     ...
     * @param ontology The ontology to be saved
     * @param ontologyFormat The format in which to save the ontology
     * @param outputStream The output stream where the ontology will be saved
     * to.
     * @throws OWLOntologyStorageException If the ontology could not be saved.
     * @throws UnknownOWLOntologyException if the specified ontology is not
     * managed by the manager.
     ...
     *
     * @param ontology The ontology to be saved.
     * @param documentTarget The output target where the ontology will be saved
     * to.
     * @throws OWLOntologyStorageException If the ontology could not be saved.
     * @throws UnknownOWLOntologyException if the specified ontology is not
     * managed by this manager.
     ...
     *
     * @param mapper The mapper to be removed. If this manager does not managed
     * the specified mapper then nothing will happen.
     */
     ...
     *
     * @param listener The listener to be added.
     * @param strategy The strategy that should be used for broadcasting changes
     * to the listener.
     */
    void addOntologyChangeListener(OWLOntologyChangeListener listener,
     ...
     *
     * @param strategy The strategy to be used for broadcasting changes. This
     * strategy will override any previously set broadcast strategy. The
     * strategy should not be {@code null}.
     ...
     * methods.
     *
     * @param declaration The declaration that describes the import to be
     * loaded.
     * @throws UnloadableImportException if there was a problem creating and
     * loading the import and silent missing imports handling is not turned on.
     * If silent missing import handling is turned on then this exception will
     * not be thrown.
     * @deprecated use
     ...
     * @param declaration The declaration that describes the import to be
     * loaded.
     * @param configuration The configuration object that passes arguments to
     * the mechanism used for loading.
     * @throws UnloadableImportException if there was a problem creating and
     * loading the import and silent missing imports handling is not turned on.
     * If silent missing import handling is turned on then this exception will
     * not be thrown.
     ...
     *
     * @param b {@code true} if loading should continue when an imported
     * ontology cannot be loaded, other wise {@code false}. The default value is
     * {@code false}.
