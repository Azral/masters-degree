 ...
 */
public abstract class RDFRendererNoSQLBase {
     ...
     */
    public RDFRendererNoSQLBase(OWLOntology ontology) {
    ...
    public RDFRendererNoSQLBase(OWLOntology ontology, OWLOntologyManager manager) {
        this(ontology, ontology.getOWLOntologyManager().getOntologyFormat(
                ontology));
    }
    ...
    @Deprecated
    @SuppressWarnings("unused")
    protected RDFRendererNoSQLBase(OWLOntology ontology, OWLOntologyManager manager,
            OWLOntologyFormat format) {
        this(ontology, format);
    }

    protected RDFRendererNoSQLBase(OWLOntology ontology, OWLOntologyFormat format) {
     ...
     * @param bannerText The banner text that will prefix the rendering of the
     * entities if anything is rendered. Not null. May be empty, in which case
